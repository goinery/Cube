...
else if(task==='verify:render-optimization'){run('node_modules/tsx/dist/cli.mjs',['tests/verify-render-optimization.ts']);run('node_modules/tsx/dist/cli.mjs',['tests/verify-viewport-core.ts']);}

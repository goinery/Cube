...
else if(task==='verify'){run('node_modules/tsx/dist/cli.mjs',['scripts/verify-core.ts']);run('node_modules/tsx/dist/cli.mjs',['scripts/verify-workflows.ts']);run('node_modules/tsx/dist/cli.mjs',['scripts/verify-interaction.ts']);run('node_modules/tsx/dist/cli.mjs',['scripts/verify-motion.ts']);run('scripts/verify-dev-worker.ts',[],['--experimental-vm-modules','--import','tsx']);}
